...
public class ControladorPrincipal {
	...
	@GetMapping("/")
	 public String controladorInicio(Model model,HttpServletRequest request) {
		//db.InsertarArticulo();		
	     ...
	     /*
	      * Recuperamos los datos de la base de datos mongo y los introducimos en una lista de objetos de la clase
	      * Pokemon para trabajar con ellos en posteriores filtros
	      */
	...
	public String controladorTipo (Model model,HttpServletRequest request) {
		...
		for (int i = 0; i<listaPokemonCompleta.size(); i++) {
			if(listaPokemonCompleta.get(i).getType1().equals(tipo) || listaPokemonCompleta.get(i).getType2().equals(tipo)) {
